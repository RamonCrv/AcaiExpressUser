...
private Activity context;
    ...
    public adapter_favorito(Activity context,String[] nome,String[] aberto,String[] naosei1,String[] naosei2,String[] nota  ){
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        viewHolder.nota.setText(nota[position]);
        return res;
    }
    ...
    ViewHolder(View view){
        ...
        nota = view.findViewById(R.id.textView5);
    }
